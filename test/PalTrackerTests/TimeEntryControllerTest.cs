...
namespace PalTrackerTests
{
    public class TimeEntryControllerTest
    {
        ...
        public void Read()
        {
            ...
            _operationCounter.Verify(oc => oc.Increment(TrackedOperation.Read));
        }
        ...
        public void Create()
        {
            ...
            Assert.Equal(expected, typedResponse.Value);
            _operationCounter.Verify(oc => oc.Increment(TrackedOperation.Create));
        ...
        public void List()
        {
            ...
            Assert.Equal(200, typedResponse.StatusCode);
            _operationCounter.Verify(oc => oc.Increment(TrackedOperation.List));
        }
        ...
        public void Update()
        {
            ...
            Assert.Equal(200, typedResponse.StatusCode);
            _operationCounter.Verify(oc => oc.Increment(TrackedOperation.Update));
        }
        ...
        public void Delete()
        {
            ...
            Assert.Equal(204, typedResponse.StatusCode);
             _operationCounter.Verify(oc => oc.Increment(TrackedOperation.Delete));
        }
